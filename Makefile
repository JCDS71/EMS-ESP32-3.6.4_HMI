...
TARGET    := emsesp
BUILD     := build
SOURCES   := src/* src/UI/* src/UI/components/* src/UI/fonts/* src/UI/screens/* src/components/* src/components/lvgl-3/* src/components/lvgl-3/src/* src/components/lvgl-3/src/core/* lib_standalone lib/uuid-common/src lib/uuid-console/src lib/uuid-log/src src/devices lib/ArduinoJson/src lib/PButton lib/semver lib/espMqttClient/src lib/espMqttClient/src/*
INCLUDES  := src/* src/UI/* src/UI/components/* src/UI/fonts/* src/UI/screens/* src/components/* src/components/lvgl-3/* src/components/lvgl-3/src/* src/components/lvgl-3/src/core/* src/components/LovyanGFX-master lib_standalone lib/espMqttClient/src lib/espMqttClient/src/Transport lib/ArduinoJson/src lib/uuid-common/src lib/uuid-console/src lib/uuid-log/src lib/uuid-telnet/src lib/uuid-syslog/src lib/semver lib/* src/devices
LIBRARIES :=
